...
### Определена функция потерь как сумма квадратов отклонений спектра фильтрованного сигнала от спектра эталона. Выполнена минимизация функции потерь методом градиентного спуска.
